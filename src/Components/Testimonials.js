const Testimonials = () => {
    return (
        <section
            style={{
                backgroundImage: "url(./images/pexels-eberhard-grossgasteiger-1367192.jpg)",
                height: "650px"
            }}
        ...
        "
            ...
            "
                    ...
                    ></div>
                    <div
                        className="review max-w-4xl rounded-sm p-12 bg-purple-500 bg-opacity-50"
                    >
                        <blockquote>
                            <q
